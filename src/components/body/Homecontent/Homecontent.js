...
<Button   style={{backgroundColor:'#fff',border:'2px solid #5D8C8E'}}    variant="outlined">Preview</Button>

      
       
    <Button   style={{backgroundColor:'#fff',border:'2px solid #5D8C8E'}}    variant="outlined">Edit</Button>
